...
void SegmentsSetlabels() {
    ...
    REQUIRE_EQ(segments_set.has_label(static_cast<label_type>(TestLabels::FIRST_LABEL)), false);
    ...
    REQUIRE_EQ(segments_set.has_label(static_cast<label_type>(TestLabels::FIRST_LABEL)), true);
    REQUIRE_EQ(segments_set.has_label(static_cast<label_type>(TestLabels::SECOND_LABEL)), true);
    REQUIRE_EQ(segments_set.has_label(static_cast<label_type>(TestLabels::THIRD_LABEL)), false);
...
#define DECLARE_TEST(TestName) TEST_CASE("") { TestName(); }
