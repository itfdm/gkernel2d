...
namespace gkernel
{
    ...
    public:
        ...
        /**
         * @brief Устанавливает типы меток для содержимого контейнера.
         *
    ...
    public:
        /**
         * @brief Создаёт новый объект SegmentsSet.
         *
         */
         ...
         *
         * @param segment_set Объект копирования.
         */
    ...
    public:
        /**
         * @brief Создаёт новый объект VertexChain.
         *
         */
    ...
    public:
        /**
         * @brief Создаёт новый объект Circuit.
         *
         */
    ...
    public:
        /**
         * @brief Создаёт новый объект CircuitsSet.
         *
         */
        ...
        /**
         * @brief Возвращает объект Circuit, хранящийся по индексу idx.
         *
         * @param idx индекс
         * @return Circuit значение, хранящееся по индексу idx.
         */
        ...
        /**
         * @brief Добавляет circuit в конец контейнера, если метки для контейнера ещё не заданы, иначе при попытке добавления будет выброшено std::runtime_error.
         *
